...
const DEFAULT_ITEMS = [
  { image: '', label: 'Panel', link: '#' }
];

/**
 * AccordionGallery
 * Hover-expanding image accordion used to showcase feature categories.
 * Panels grow on hover/focus/click while inactive panels tilt, dim and
 * grayscale slightly, revealing a label + accent bar.
 */
